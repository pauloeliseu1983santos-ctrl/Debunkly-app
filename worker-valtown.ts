// Debunkly — proxy de leitura de página (versão Val Town)
// Cole isto dentro de um "HTTP val" novo no val.town e clique em salvar/publicar.
// A URL final vai ser algo como: https://SEU-USUARIO-debunklyproxy.web.val.run
